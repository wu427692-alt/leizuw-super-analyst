...
WEB_SETTINGS_HIDDEN_FROM_UI = {
    # Internal worker/runtime tuning.  These remain supported in .env but are
    # intentionally not exposed as ordinary user settings because changing
    # them requires service-level operational knowledge and a restart.
    "APP_STARTUP_WARMUP",
    "APP_STARTUP_WARMUP_DELAY_SECONDS",
    "APP_STARTUP_WARMUP_PROFILE",
    "APP_DEBUG_FILE_LOG_ENABLED",
    "APP_LOG_RETENTION_DAYS",
    "ESSAY_DASHBOARD_ROWS_CACHE_MAX_ENTRIES",
    "ESSAY_DEEP_INSIGHTS_CACHE_MAX_ENTRIES",
    "ESSAY_SUMMARY_CACHE_MAX_ENTRIES",
    "DATA_STORAGE_MAINTENANCE_AUTO_START",
    "DATA_STORAGE_MAINTENANCE_MINUTES",
    "ESSAY_QUANT_AUTO_START",
    "ESSAY_QUANT_MIN_INTERVAL_SEC",
    "ESSAY_QUANT_PRICE_REFRESH_SEC",
    "ESSAY_QUANT_RECENT_TRADE_DAYS",
    "ESSAY_QUANT_STARTUP_DELAY_SEC",
    "INVESTMENT_MONITOR_MAX_WORKERS",
    "INVESTMENT_MONITOR_NEWS_LIVE_OVERLAP_MINUTES",
    "INVESTMENT_MONITOR_NEWS_OVERLAP_MINUTES",
    "DATABASE_PATH",
...
_FIELD_DEFINITIONS: Dict[str, Dict[str, Any]] = {
    ...
    "LLM_PROVIDER_SCHEDULE_ENABLED": {
        "title": "Calendar Provider Rotation",
        "description": "Rotate the primary low-cost provider by Shanghai calendar day. Defaults to Kimi Code on days 9-23 and DeepSeek V4 Flash on days 24-8; the inactive provider is the only fallback.",
        "category": "ai_model",
        "data_type": "boolean",
        "ui_control": "switch",
        "is_sensitive": False,
        ...
        "validation": {},
        "display_order": 3,
        "help_key": "settings.ai_model.LLM_PROVIDER_SCHEDULE_ENABLED",
        "examples": ["LLM_PROVIDER_SCHEDULE_ENABLED=true"],
        "docs": [{
            "label": "DeepSeek / Kimi 日历轮换说明",
            "href": "https://github.com/wu427692-alt/financial-intelligence-platform/blob/main/docs/llm-providers.md",
        }],
        "warning_codes": [],
    },
    "LLM_PROVIDER_SCHEDULE_TIMEZONE": {
        "title": "Provider Rotation Timezone",
        "description": "IANA timezone used to switch the active provider at the calendar-day boundary.",
        "category": "ai_model",
        "data_type": "string",
        "ui_control": "text",
        "is_sensitive": False,
        ...
        "validation": {},
        "display_order": 3,
        "help_key": "settings.ai_model.LLM_PROVIDER_SCHEDULE_TIMEZONE",
        "examples": ["LLM_PROVIDER_SCHEDULE_TIMEZONE=Asia/Shanghai"],
        "docs": [{
            "label": "DeepSeek / Kimi 日历轮换说明",
            "href": "https://github.com/wu427692-alt/financial-intelligence-platform/blob/main/docs/llm-providers.md",
        }],
    ...
    "LLM_PROVIDER_SCHEDULE_KIMI_START_DAY": {
        "title": "Kimi Rotation Start Day",
        "description": "Calendar day on which Kimi Code becomes primary (inclusive).",
        "category": "ai_model",
        "data_type": "integer",
        "ui_control": "number",
        "is_sensitive": False,
        ...
        "display_order": 3,
        "help_key": "settings.ai_model.LLM_PROVIDER_SCHEDULE_KIMI_START_DAY",
        "examples": ["LLM_PROVIDER_SCHEDULE_KIMI_START_DAY=9"],
        "docs": [{
            "label": "DeepSeek / Kimi 日历轮换说明",
            "href": "https://github.com/wu427692-alt/financial-intelligence-platform/blob/main/docs/llm-providers.md",
        }],
    ...
    "LLM_PROVIDER_SCHEDULE_DEEPSEEK_START_DAY": {
        "title": "DeepSeek Rotation Start Day",
        "description": "Calendar day on which DeepSeek V4 Flash becomes primary (inclusive).",
        "category": "ai_model",
        "data_type": "integer",
        "ui_control": "number",
        "is_sensitive": False,
        ...
        "validation": {"min": 1, "max": 31},
        "display_order": 3,
        "help_key": "settings.ai_model.LLM_PROVIDER_SCHEDULE_DEEPSEEK_START_DAY",
        "examples": ["LLM_PROVIDER_SCHEDULE_DEEPSEEK_START_DAY=24"],
        "docs": [{
            "label": "DeepSeek / Kimi 日历轮换说明",
            "href": "https://github.com/wu427692-alt/financial-intelligence-platform/blob/main/docs/llm-providers.md",
        }],
    ...
    "LLM_PROVIDER_SCHEDULE_KIMI_MODEL": {
        "title": "Kimi Rotation Model",
        "description": "Configured Kimi Code route used during the Kimi calendar window.",
        "category": "ai_model",
        "data_type": "string",
        "ui_control": "text",
        "is_sensitive": False,
        "is_required": False,
        "is_editable": True,
        "default_value": "openai/kimi-for-coding",
        "options": [],
        "validation": {},
        "display_order": 3,
        "help_key": "settings.ai_model.LLM_PROVIDER_SCHEDULE_KIMI_MODEL",
        "examples": ["LLM_PROVIDER_SCHEDULE_KIMI_MODEL=openai/kimi-for-coding"],
        "docs": [{
            "label": "Kimi Code 官方文档",
            "href": "https://www.kimi.com/code/docs/",
        }],
        "warning_codes": ["provider_prefix_required"],
    },
    "LLM_PROVIDER_SCHEDULE_DEEPSEEK_MODEL": {
        "title": "DeepSeek Rotation Model",
        "description": "Configured low-cost DeepSeek route used during the DeepSeek calendar window.",
        "category": "ai_model",
        "data_type": "string",
        "ui_control": "text",
        "is_sensitive": False,
        ...
        "validation": {},
        "display_order": 3,
        "help_key": "settings.ai_model.LLM_PROVIDER_SCHEDULE_DEEPSEEK_MODEL",
        "examples": ["LLM_PROVIDER_SCHEDULE_DEEPSEEK_MODEL=deepseek/deepseek-v4-flash"],
        "docs": [{
            "label": "DeepSeek / Kimi 日历轮换说明",
            "href": "https://github.com/wu427692-alt/financial-intelligence-platform/blob/main/docs/llm-providers.md",
        }],
    ...
    "AUDIO_TRANSCRIPTION_API_KEY": {
        "title": "兼容转写 API Key（备用）",
        "description": "仅在未使用阿里云百炼时，供 OpenAI-compatible /audio/transcriptions 转写服务使用。",
        "category": "ai_model",
        "data_type": "string",
        "ui_control": "password",
        "is_sensitive": True,
        ...
        "display_order": 12,
        "help_key": "settings.ai_model.provider_keys",
        "examples": ["AUDIO_TRANSCRIPTION_API_KEY=sk-xxxx"],
        "docs": [{"label": "录音纪要配置", "href": "https://github.com/wu427692-alt/financial-intelligence-platform/blob/main/docs/financial-data-api.md"}],
        "warning_codes": ["secret_value"],
    },
    "AUDIO_TRANSCRIPTION_BASE_URL": {
        "title": "兼容转写 API 地址（备用）",
        "description": "备用 OpenAI-compatible API 根地址；阿里云百炼转写不使用此项。",
        "category": "ai_model",
        "data_type": "string",
        "ui_control": "text",
        "is_sensitive": False,
        ...
        "examples": ["AUDIO_TRANSCRIPTION_BASE_URL=https://api.openai.com/v1"],
        "docs": [{"label": "录音纪要配置", "href": "https://github.com/wu427692-alt/financial-intelligence-platform/blob/main/docs/financial-data-api.md"}],
        "warning_codes": [],
    },
    "AUDIO_TRANSCRIPTION_MODEL": {
        "title": "兼容转写模型（备用）",
        "description": "备用 OpenAI-compatible 转写模型名称；阿里云模型请配置 DASHSCOPE_ASR_MODEL。",
        "category": "ai_model",
        "data_type": "string",
        "ui_control": "text",
        "is_sensitive": False,
        ...
        "display_order": 14,
        "help_key": "settings.ai_model.legacy_provider_params",
        "examples": ["AUDIO_TRANSCRIPTION_MODEL=<上游实际支持的模型名>"],
        "docs": [{"label": "录音纪要配置", "href": "https://github.com/wu427692-alt/financial-intelligence-platform/blob/main/docs/financial-data-api.md"}],
        "warning_codes": [],
    },
    "DASHSCOPE_API_KEY": {
        "title": "阿里云百炼 API Key",
        "description": "用于公司录音的阿里云百炼异步语音识别；也会复用已配置的 LLM_DASHSCOPE_API_KEY。",
        "category": "ai_model",
        "data_type": "string",
        "ui_control": "password",
        "is_sensitive": True,
        ...
        "display_order": 15,
        "help_key": "settings.ai_model.provider_keys",
        "examples": ["DASHSCOPE_API_KEY=sk-xxxx"],
        "docs": [{"label": "阿里云录音文件识别", "href": "https://help.aliyun.com/zh/model-studio/fun-asr-recorded-speech-recognition-http-api"}],
        "warning_codes": ["secret_value"],
    },
    "AUDIO_TRANSCRIPTION_PROVIDER": {
        "title": "录音转写服务",
        "description": "默认自动优先使用阿里云百炼；只有明确需要兼容服务时才切换。",
        "category": "ai_model",
        "data_type": "string",
        "ui_control": "select",
        "is_sensitive": False,
        ...
        "is_editable": True,
        "default_value": "auto",
        "options": ["auto", "aliyun_dashscope", "openai_compatible"],
        "validation": {},
        "display_order": 16,
        "help_key": "settings.ai_model.legacy_provider_params",
        "examples": ["AUDIO_TRANSCRIPTION_PROVIDER=aliyun_dashscope"],
        "docs": [{"label": "录音纪要配置", "href": "https://github.com/wu427692-alt/financial-intelligence-platform/blob/main/docs/financial-data-api.md"}],
        "warning_codes": [],
    },
    "DASHSCOPE_ASR_BASE_URL": {
        "title": "阿里云语音识别地址",
        "description": "默认使用北京地域公共地址；使用新加坡或业务空间专属域名时在此替换。",
        "category": "ai_model",
        "data_type": "string",
        "ui_control": "text",
        "is_sensitive": False,
        "is_required": False,
        "is_editable": True,
        "default_value": "https://dashscope.aliyuncs.com",
        "options": [],
        "validation": {"format": "url"},
        "display_order": 17,
        "help_key": "settings.ai_model.legacy_provider_params",
        "examples": ["DASHSCOPE_ASR_BASE_URL=https://dashscope.aliyuncs.com"],
        "docs": [{"label": "阿里云录音文件识别", "href": "https://help.aliyun.com/zh/model-studio/fun-asr-recorded-speech-recognition-http-api"}],
        "warning_codes": [],
    },
    "DASHSCOPE_ASR_MODEL": {
        "title": "阿里云录音识别模型",
        "description": "公司会议录音默认使用支持长音频、专业词汇和说话人分离的文件转写模型。",
        "category": "ai_model",
        "data_type": "string",
        "ui_control": "text",
        "is_sensitive": False,
        "is_required": False,
        "is_editable": True,
        "default_value": "qwen-audio-3.0-asr-flash-filetrans",
        "options": [],
        "validation": {},
        "display_order": 18,
        "help_key": "settings.ai_model.legacy_provider_params",
        "examples": ["DASHSCOPE_ASR_MODEL=qwen-audio-3.0-asr-flash-filetrans"],
        "docs": [{"label": "阿里云语音模型选型", "href": "https://help.aliyun.com/zh/model-studio/asr-model"}],
        "warning_codes": [],
    },
    "DASHSCOPE_ASR_DIARIZATION_ENABLED": {
        "title": "录音说话人分离",
        "description": "开启后在转写文本中保留说话人编号和句级时间戳，便于回听核验。",
        "category": "ai_model",
        "data_type": "boolean",
        "ui_control": "switch",
        "is_sensitive": False,
        ...
        "display_order": 19,
        "help_key": "settings.ai_model.legacy_provider_params",
        "examples": ["DASHSCOPE_ASR_DIARIZATION_ENABLED=true"],
        "docs": [{"label": "阿里云录音文件识别", "href": "https://help.aliyun.com/zh/model-studio/fun-asr-recorded-speech-recognition-http-api"}],
        "warning_codes": [],
    },
    "TUSHARE_TOKEN": {
