...
CLUSTER_RULES: Sequence[Tuple[str, Sequence[str]]] = (
    ...
    ("光通信器件与互连", ("OCS", "MPO", "薄膜铌酸锂", "TFLN", "高速耦合透镜", "法拉第旋片")),
    ("PCB/CCL产业链", ("PCB", "CCL", "覆铜板", "电子布", "玻纤布")),
    ("AI数据中心", ("算力", "数据中心", "服务器", "液冷", "超节点")),
    ("AI芯片与基础软件", ("RISC-V", "CANN", "FP8", "GPU", "国产操作系统", "MLOPS", "深度学习", "神经网络")),
    ("通信网络与物联网", ("5G", "6G", "F5G", "网络切片", "交换机", "通信服务", "物联网", "ESIM", "RCS")),
    ("数据安全与信创", ("信创", "网络安全", "数据安全", "信息安全", "自主可控", "国资云")),
    ("数据要素与数字政务", ("数据要素", "数据确权", "数字政务", "智慧政务", "数字身份", "电子身份证")),
    ("半导体设备材料", ("光刻", "晶圆", "半导体设备", "电子气体", "电子特气", "洁净室", "涂胶显影")),
    ("先进封装与载板", ("先进封装", "CHIPLET", "ABF", "IC载板", "玻璃基板")),
    ("显示与消费电子", ("OLED", "MINILED", "MICROLED", "折叠屏", "柔性屏", "3D玻璃", "智能戒指", "无线耳机")),
    ("低空经济", ("低空", "EVTOL", "无人机", "空管")),
    ("商业航天", ("商业航天", "卫星", "火箭", "航天")),
    ("人形机器人", ("人形机器人", "减速器", "丝杠", "灵巧手")),
    ("工业母机与自动化", ("工业母机", "数控", "自动化", "智能制造", "工业4.0", "盾构机")),
    ("智能驾驶", ("智能驾驶", "无人驾驶", "激光雷达", "车联网")),
    ("动力电池与充换电", ("动力电池", "锂电", "充电桩", "800V快充", "换电", "V2G")),
    ("创新药", ("创新药", "ADC", "双抗", "减肥药", "小核酸")),
    ("医疗器械与服务", ("医疗器械", "体外诊断", "注射器", "民营医院", "SPD", "医美", "美容护理")),
    ("新型电力系统", ("储能", "电网", "电力", "虚拟电厂", "特高压")),
    ("光伏与风电", ("光伏", "太阳能", "风电", "BIPV", "光热发电")),
    ("氢能与核聚变", ("氢能", "可控核聚变", "人造太阳", "ITER", "SOFC")),
    ("农业种植与农资", ("种植", "种业", "转基因", "玉米", "化肥", "农药", "农机")),
    ("养殖与食品", ("猪肉", "鸡肉", "禽肉", "水产", "养殖", "乳业", "预制菜")),
    ("零售电商与品牌", ("零售", "电商", "电子商务", "C2M", "微信小店", "免税", "超级品牌")),
    ("传媒游戏与内容", ("传媒", "游戏", "影视", "动漫", "短剧", "网红直播", "知识产权")),
    ("酒类与大众消费", ("白酒", "啤酒", "黄酒", "酿酒", "食品", "调味品")),
    ("有色与贵金属", ("有色", "黄金", "白银", "稀土", "铜", "铝", "锂", "钴", "钨", "锑")),
    ("化工与新材料", ("化工", "甲醇", "尿素", "纯碱", "硫酸", "PVDF", "TDI", "新材料")),
    ("煤炭油气", ("煤炭", "动力煤", "焦炭", "石油", "原油", "天然气", "燃气")),
    ("交通物流", ("物流", "快递", "航运", "港口", "铁路", "高铁", "机场", "民航")),
    ("建筑基建与水网", ("基建", "建筑", "城市更新", "水网", "水利", "地下管网", "园林工程")),
    ("银行券商保险", ("银行", "证券", "券商", "保险")),
    ("地产与资产运营", ("地产", "房地产", "物业", "REITS")),
)
