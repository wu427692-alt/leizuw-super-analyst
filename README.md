...
`/concept-themes` 汇总同花顺、东方财富、开盘啦、通达信与申万口径，按题材家族、产业链簇、原始来源题材和成分股逐层浏览，并以独立候选层展示近 30 日机构语料中的新兴题材、提及加速度与关联股票。个股题材权重综合来源共识、业务证据、市场热度与专属性；20/60/120 日归因使用剔除自身后的题材组合并控制沪深300，分别呈现题材 Beta、95% 区间、窗口 Alpha、R²、统计置信等级及可回到原文核验的公司独特证据。全市场成分补库采用数据库任务账本，重启可续跑；AI 发现不会自动冒充市场共识。完整方法见 [概念题材共识引擎](docs/concept-theme-consensus.md)。
